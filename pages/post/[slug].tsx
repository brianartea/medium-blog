    ...
    <main>
      ...
      {submitted ? (
        <div className="flex flex-col text-center py-10 my-10 bg-green-600 text-white max-w-2xl mx-auto">
          ...
          <p className="text-lg">Once it's approved it will show below!</p>
        </div>
      ) : (
        <form
        ...
        >
          ...
          <div className="flex flex-col p-5">
            ...
            {errors.comment && (
              <span className="text-red-500"> - Comment field required</span>
            )}
          </div>
          <input
            type="submit"
            className="shadow py-2 px-4 bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-white font-bold cursor-pointer"
          />
        </form>
      )}
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // sfter 60 seconds it will update the old cache version
  };
};
